...
namespace BepInPluginSample
{
    class SamplePatch
    {
        ...
        {
            Sample.myLog.LogMessage("CharacterMgr.SetActive", f_nActiveSlotNo, f_bMan, f_maid.status.fullNameEnStyle);
        }
        ...
        {
            Sample.myLog.LogMessage("CharacterMgr.Deactivate", f_nActiveSlotNo, f_bMan);
        }
    }
}
