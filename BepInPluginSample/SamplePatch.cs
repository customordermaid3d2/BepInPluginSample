...
namespace BepInPluginSample
{
    class SamplePatch
    {
        ...
        {
            Sample.log.LogMessage($"CharacterMgr.SetActive, {f_nActiveSlotNo}, {f_bMan}, {f_maid.status.fullNameEnStyle}");
        }
        ...
        {
            Sample.log.LogMessage($"CharacterMgr.Deactivate, {f_nActiveSlotNo}, {f_bMan}");
        }
    }
}
